...
//                                     CGRectGetWidth(self.onContentView.bounds) - lMargin - self.ballSize - 2 * margin,
//                                     lHeight);
    self.onLabel.frame = CGRectMake(6,
                                    4,
                                    8,
                                    9);
    self.onLabel.centerY = 8.5;
    
    self.offLabel.frame = CGRectMake(24,
                                     4,
                                     8,
                                     9);
}
