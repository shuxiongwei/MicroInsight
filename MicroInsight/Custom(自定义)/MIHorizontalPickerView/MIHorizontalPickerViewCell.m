...
@interface MIHorizontalPickerViewCell ()
...
@implementation MIHorizontalPickerViewCell
#pragma mark - setter && getter
- (void)setItem:(MIHorizontalPickerViewCellItem *)item
{
    _item = item;
