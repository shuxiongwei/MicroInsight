...
@class MIHorizontalPickerView, MIHorizontalPickerViewCell;
@protocol MIHorizontalPickerViewDelegate <NSObject>
...
@interface MIHorizontalPickerView : UIView
...
//代理和数据源
@property (nonatomic, weak) id<MIHorizontalPickerViewDelegate> delegate;
