//
//  MIForwardPasswordViewController.swift
//  MicroInsight
//
...
class MIForwardPasswordViewController: MIBaseViewController {
    ...
    override func viewDidLoad() {
        ...
        configForwardPasswordUI()
    }
    
    private func configForwardPasswordUI() {
        super.configLeftBarButtonItem(nil)
        self.title = MILocalData.appLanguage("login_key_5")
        ...
        passwordTF.setValue(MILocalData.appLanguage("login_key_10"), forKeyPath: "_placeholderLabel.text")
    }
    ...
    @IBAction func clickAuthCodeBtn(_ sender: UIButton) {
        ...
        MIRequestManager.getMessageVerificationCode(withMobile: phoneTF.text!, type: 3) { (jsonData: Any?, error: Error?) in
